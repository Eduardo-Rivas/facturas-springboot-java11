...
import com.edujava.facturas.entities.OrderItem;
...
import com.edujava.facturas.repositories.OrderItemRepository;
...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		//--Asociacion de Claves Extranjeras Productos-Catgorias--//
		...
		//--Salvamos Nuevamente la Tabla Producto--//
		productRepository.saveAll(Arrays.asList(p1,p2,p3,p4,p5));
		...
		//--Instanciamos OrderItems--//
		OrderItem oi1 = new OrderItem(o1, p1, 2, p1.getPrice());
		OrderItem oi2 = new OrderItem(o1, p3, 1, p3.getPrice());
		OrderItem oi3 = new OrderItem(o2, p3, 2, p3.getPrice());
		OrderItem oi4 = new OrderItem(o3, p5, 2, p5.getPrice());
		
		//--Salvamos los Datos de OrdenItem--//
